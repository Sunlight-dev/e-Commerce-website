  ...
  return (
    <div className={Styles.view}>
        ...
        <div className={Styles.wrapper}>
            ...
            <p>After making your purchase, our team springs into action.    We'll carefully prepare your tech treasures and ship them to the   address you provided during checkout. Your products' safety is    our priority, ensuring they arrive in perfect condition.</p>
            </div>
